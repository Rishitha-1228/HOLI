...
// Fluid Simulation Code (Original Code)
// ... (Aapka diya gaya fluid simulation code yahan paste karein)

// Typing Effect for Holi Messages
const messageElement = document.getElementById('message');
const finalMessageElement = document.getElementById('final-message');
const messageContainer = document.getElementById('message-container');
const holiButton = document.getElementById('holi-button');
const messages = [
    "Fill the world with the colors of HOLI",
    "Shower happiness all around..",
    "Fill every heart with the color of LOVE..",
];
let messageIndex = 0;
let charIndex = 0;
...
function eraseMessage() {
    if (charIndex > 0) {
        messageElement.textContent = messages[messageIndex].substring(0, charIndex - 1);
        charIndex--;
        setTimeout(eraseMessage, 50); // Erasing speed
    } else {
